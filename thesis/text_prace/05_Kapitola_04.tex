...
standardní integerovské(správný termín???) aritmetiky a následně všechny částečné výsledky spojit
...
prvočíselné(nemá být ve tvaru prvočíselnými???) faktory $ m $. V praxi $ m $ obvykle získáme tak, že postupně
...
je schopen provádět většinu výpočtů ve standardní 32bitové aritmetice. Výpočet
mezi body konvergence navíc můžeme provádět paralelně ve více vláknech.
