...
prvočíselné faktory $ m $. V praxi $ m $ obvykle získáme tak, že postupně
přidáváme prvočísla dokud jejich součin není dostatečně velký.
...
délka bude $ l = 6 + \log_2(10^4 \log_2(10^2 \Vert A \Vert)) $. Konkrétně
pokud dosadíme $ \Vert A \Vert = 2^{31} $, zjistíme, že by nám stačila prvočísla
...
v okruzích $ \Zbb / p_i \Zbb $. Avšak autor také uvádí, že aby byl algoritmus
...
Nejprve musíme identifikovat všechny místa algoritmu z věty \ref{SNF_Triang},
která vyžadují výpočet nějakých koeficientů. V lemmatu \ref{Sloup_elim_GCD}
se jedná koeficient $ c $, který počítáme pomocí Bachova lemmatu. Lemma
