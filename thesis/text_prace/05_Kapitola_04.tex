...
hodnost a byla horní trojúhelníková. Pak můžeme uvážit následující funkci.\\
%
    \begin{algorithm}[htp]
        ...
        \myproc{\fun{
                        Matice $ A $ o rozměrech $ k \times m $ jejíž hlavní 
                        $ k \times k $ submatice je regulární a horní trojúhelníková}} 
        {
...
Každý její běh bude jistě konečný a postupně převede všechny submatice tvořené 
posledními $ i $ řádky do diagonálně dominantního tvaru.
\end{proof}
