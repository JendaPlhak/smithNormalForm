...
dvou případech, kdy za $ c $ volíme $ 0 $ a $ 1 $, jsou evidentně podmínky
kladené na koeficient $ c $ splněny. Zaměřme tedy naši pozornost na třetí
...
plyne z požadavků, které klademe na $ c $. Druhá pak z toho, že $ X $ bude
obsahovat všechny společné dělitele $ N $ a $ a $ a navíc z předpokladů máme
$ \gcd(a,b,N) = 1 $.
Podobně platí
$ \gcd(a + cb,Y) = \gcd(a,Y) = 1 $, protože z lemmatu \ref{factorization}
máme $ \gcd(g, Y) = 1 $, $ N = XY $ a zvolili jsme $ g = \gcd(a, N) $.
