...
zajistíme splnění podmínky (2), neboť $ c_l = -\bar{t} \leq 0 < x $. Platnost
...
%  \int\! f(x)\,\mathrm{d}x
% \end{equation*}
% odkaz na rovnici s \uv{tagem} \eqref{E} -- pokud nechcete vzorci přidělit číslo,
% ale nějaký vlastní symbol, používejte
