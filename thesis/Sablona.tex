...
\Abstrakty%
{V této bakalářské práci se věnujeme algoritmům pro výpočet Smithova normálního tvaru, který nalézá uplatnění například při řešení soustav celočíselných rovnic nebo při počítání simpliciálních homologií. V průběhu výpočtu Smithova normálního tvaru můžeme už pro malé matice narazit na problémy s bitovou délkou mezivýsledků. Proto zde uvádíme algoritmus, pro nějž odvozujeme odhad na mezivýsledky. Tento algoritmus modifikujeme tak, abychom mohli s využitím Čínské zbytkové věty garantovat dostatečně malou bitovou délku mezivýsledků a umožnili jistou míru paralelizace výpočtu.}%
...
\DatumProhlaseni{28. května 2014}
