...
\KlicovaSlova{Smithův normální tvar; Redukovaný schodovitý tvar; Algoritmus; Čínská zbytková věta}{Smith normal form; Row reduced echelon form; Algorithm; Chinese remainder theorem}

\Abstrakty%
{V této bakalářské práci se věnujeme algoritmům pro výpočet Smithova normálního tvaru.}%
...
\DatumProhlaseni{xx. měsíce 2014}
